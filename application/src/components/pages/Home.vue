<template>
   <main class="l-home-page">
     <app-header :budgetsVisible="budgetsVisible"
                  @toggleVisibleData="budgetsVisible = !budgetsVisible"
      ...
      <v-speed-dial v-model="fab"
          ...
          <v-tooltip left>
            <v-btn color="light-blue lighten-1"
                   ...
                   slot="activator"
                   @click.native=
                   "budgetCreation = true; listPage = false; editPage = false; createPage = true">
          ...
          <v-tooltip left>
            <v-btn color="green lighten-1"
                   ...
                   slot="activator"
                   @click.native=
                   "budgetCreation = false; listPage = false; editPage = false; createPage = true">
